...
export const AREAS: Record<AreaKey, AreaConfig> = {
  ...
  singapore: {
    ...
    zoom: 10,
    circumference: 'data/singapore-circumference.json?v=20260728c',
    liveRoads: true,
    stations: 'data/singapore-stations.geojson?v=20260728b',
    metadata: 'data/singapore-metadata.json?v=20260728b',
    schedules: 'data/singapore-schedules.json?v=20260728c',
  ...
  atlanta: {
    ...
    center: [-84.388, 33.75],
    zoom: 10,
    circumference: 'data/atlanta-circumference.json?v=20260728b',
    liveRoads: true,
    stations: 'data/atlanta-stations.geojson?v=20260728b',
    metadata: 'data/atlanta-metadata.json?v=20260728b',
    schedules: 'data/atlanta-schedules.json?v=20260728b',
    timezone: 'America/New_York',
    supportsDestination: true,
  ...
  athens: {
    ...
    zoom: 10.5,
    circumference: 'data/athens-circumference.json?v=20260728b',
    liveRoads: true,
    stations: 'data/athens-stations.geojson?v=20260728a',
    metadata: 'data/athens-metadata.json?v=20260728a',
    schedules: 'data/athens-schedules.json?v=20260728b',
